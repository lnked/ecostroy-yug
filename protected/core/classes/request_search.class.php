...
class Request_search extends Initialize
{
	public $site			=	'';
	public $hash			=	'';
	public $stops			=	array();
	...
	public function find()
	{
		...
		if ($query && mb_strlen($query) >= $this->minimum_length)
		{
	...
	private function Query($words = array(), $current = 0)
	{
