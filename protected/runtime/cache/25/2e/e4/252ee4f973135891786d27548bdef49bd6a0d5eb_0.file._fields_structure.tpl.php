...
/* Smarty version 3.1.32-dev-1, created on 2017-06-19 11:10:27
  from "/Users/edik/web/ecostroy.dev/protected/templates/admin/view/structure/_fields_structure.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32-dev-1',
  'unifunc' => 'content_594786f35341d8_82013719',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '252ee4f973135891786d27548bdef49bd6a0d5eb' => 
    array (
      0 => '/Users/edik/web/ecostroy.dev/protected/templates/admin/view/structure/_fields_structure.tpl',
      1 => 1469786303,
      2 => 'file',
    ),
  ),
...
function content_594786f35341d8_82013719 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
}?>" disabled="disabled"><input type="hidden" name="stc_sys_name" value="main"><?php } else { ?><div class="url__lock"><span class="url__lock__switch <?php if ($_smarty_tpl->tpl_vars['method']->value == 'edit') {?>off<?php } else { ?>on<?php }?> js-toggle-binding" data-element="#stc_sys_name" title="Нажмите на замок, чтобы внести / запретить изменения"><span class="icon icon-lock-open is-on"></span><span class="icon icon-lock-outline is-off"></span></span></div><input name="stc_sys_name" id="stc_sys_name" class="ness<?php if (isset($_smarty_tpl->tpl_vars['stc_errors']->value) && in_array('sys_name',$_smarty_tpl->tpl_vars['stc_errors']->value)) {?> error<?php }?> js-binding" data-binding-name="stc_name" data-binding-element="stc_sys_name" value="<?php if (isset($_smarty_tpl->tpl_vars['stc_page']->value['sys_name'])) {
echo $_smarty_tpl->tpl_vars['stc_page']->value['sys_name'];
...
?>
</select></div></td></tr><tr style="display: none;"><td class="h hl va_m">Шаблон страницы</td><td><?php if (isset($_smarty_tpl->tpl_vars['templates_list']->value)) {?><div class="width-50" style="position: relative"><div id="select_field"><select name="stc_tid" id="templates_list"><?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);
?>
</select></div><?php if (isset($_SESSION['userinf']['gid']) && $_SESSION['userinf']['gid'] == 10) {?><a href="#" class="button button-blue button-icon" onclick="addTemplate(event);return false" style="position: absolute; left: 100%; margin-left: 2px; top: 0;"><span class="icon icon-plus-square"></span></a><?php }?></div><?php }
if (isset($_SESSION['userinf']['gid']) && $_SESSION['userinf']['gid'] == 10) {?><div class="clearfix hidden" id="addtemplate" style="padding: 10px 0 0;"><div class="width-25 fl"><div style="padding: 0 1px 0 0;"><input name="template_name" id="template_name" disabled placeholder="Название шаблона"></div></div><div class="width-25 fl"><div style="padding: 0 0 0 1px;"><input name="template_file" id="template_file" disabled placeholder="Файл шаблона"></div></div><div class="width-25 fl"><div style="padding: 0 0 0 2px;"><button class="button button-green" onclick="return addTemplateFile(<?php if (isset($_smarty_tpl->tpl_vars['stc_page']->value['tid'])) {
