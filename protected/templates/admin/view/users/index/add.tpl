	...
	<table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <input name="password" id="password" class="w25 mb10"><a href="#" onclick="return secret('#password')" class="button button-purple button-icon"><i class="icon icon-refresh"></i></a>
