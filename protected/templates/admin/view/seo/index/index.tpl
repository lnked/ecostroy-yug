...
<div class="button-container">
    <a href="/{$ADMIN_DIR}/seo/scan"class="button button-blue" data-no-instant><i class="icon icon-ok-circle"></i>Начать сканирование</a>
</div>
...
<form method="post">
    ...
    <div class="button-container">
        <button class="button button-green" type="submit"><i class="icon icon-save"></i>Сохранить настройки</button>
        <a class="button button-red" href="/{$ADMIN_DIR}/seo/settings/"><i class="icon icon-arrow-left"></i>Отмена</a>
    </div>
</form>
{/strip}