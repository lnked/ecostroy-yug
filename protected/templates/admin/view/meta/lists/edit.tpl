	...
	<table class="table">
        ...
        <tbody>
            ...
            <tr id="tr{$smarty.foreach.i.iteration}">
                ...
                <td class="tac">
                    <a href="#" class="icon icon-delete" title="Удалить" onclick="del_list_fields({$smarty.foreach.i.iteration});return false;"></a>
                </td>
            </tr>
            {/foreach}
            <tr id="add_btn">
                <td colspan="5">
                    <a href="#" title="Добавить" class="fr" onclick="add_list_fields_list();return false;"><span class="icon icon-plus-square"></span> Добавить</a>
                </td>
            </tr>
        </tbody>
	</table>
