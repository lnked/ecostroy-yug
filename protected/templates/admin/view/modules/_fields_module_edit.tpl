    ...
    <tbody>
        ...
        <tr id="tr{$index}" valign="top"{if in_array($it.f_sys_name, array('meta_title', 'meta_keywords', 'meta_description', 'meta_robots'))} style="display: none"{/if}>
            ...
            <td class="addition va_t">
                {if $it.f_type == 'cost' || $it.f_type == 'autocomplete' || $it.f_type == 'int' || $it.f_type == 'hidden' || $it.f_type == 'document' || $it.f_type == 'timestamp' || $it.f_type == 'email' || $it.f_type == 'list' || $it.f_type == 'select' || $it.f_type == 'float' || $it.f_type == 'input' || $it.f_type == 'system' || $it.f_type == 'multiselect' || $it.f_type == 'datetime'}
                    ...
                    {if $it.f_type == 'list' || $it.f_type == 'autocomplete' || $it.f_type == 'select' || $it.f_type == 'radio' || $it.f_type == 'checkbox' || $it.f_type == 'multiselect' || $it.f_type == 'system'}
                ...
                <div class="js-size-list">
                                ...
                                <tr data-index="{$key}">
                                    ...
                                    <td class="va_t">
                                        <div class="option-group option-combo option-simple simple">
                                            <label title="Crop image"><input type="radio" name="f_image_photo_method[{$index}][{$key}]" value="crop"{if $it.f_settings.f_image_photo_method[$key] == 'crop'} checked{/if}><span class="option"><i class="icon icon-crop-free"></i></span></label>
                                            <label title="Resize image"><input type="radio" name="f_image_photo_method[{$index}][{$key}]" value="resize"{if !isset($it.f_settings.f_image_photo_method[$key]) || $it.f_settings.f_image_photo_method[$key] == 'resize'} checked{/if}><span class="option"><i class="icon icon-photo-size-select-large"></i></span></label>
                                        </div>
                                    </td>
                                    <td class="va_m">
                    ...
                    <a href="#" class="add-size js-add-size" data-iteration="{$index}"><i class="icon icon-plus-square"></i> Добавить размер</a>
                </div>
                {/if}
                
                {if $it.f_type == 'section' || $it.f_type == 'autocomplete' || $it.f_type == 'select' || $it.f_type == 'radio' || $it.f_type == 'checkbox' || $it.f_type == 'multiselect'}
            ...
            <td class="tac va_t"><a href="#" class="icon icon-delete" title="Удалить" onclick="del_fields({$index});return false;"></td>
        </tr>
        {/foreach}
        <tr id="add_btn">
            <td colspan="9">
                <a onclick="add_fields();return false;" class="button-link fr" title="Добавить" href="#"><span class="icon icon-plus-square"></span> Добавить</a>
            </td>
        </tr>
    </tbody>
</table>
