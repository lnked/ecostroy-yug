    ...
    <tbody>
        ...
        <tr class="row-{$item.id}">
            ...
            <td class="va_m tac">
                ...
                <a href="{$base_path}/index/del/{$item.id}" rel=".row-{$item.id}" class="icon icon-delete remove-trigger" title="Удалить" onclick="return cp.dialog('Вы действительно хотите удалить модуль и все что связанно с ним?');" data-no-instant></a>
            </td>
        </tr>
        {/foreach}
    </tbody>
...
<a href="{$base_path}/index/add" class="button button-purple"><i class="icon icon-plus-square"></i>Добавить модуль</a>
<a href="{$base_path}/clean" class="button button-blue fr"><i class="icon icon-wrench"></i>Починить таблицы</a>
{/strip}