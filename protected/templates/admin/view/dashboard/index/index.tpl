    ...
    {foreach from=$permissions item=item key=id}
        <div class="apply notice">
            ...
            <div class="button-container mb5 clearfix">
                <a href="{$base_path}/perm/edit/{$id}/" class="button button-green"><i class="icon icon-wrench"></i>Исправить</a>
            </div>
        </div>
    {/foreach}
{/if}
...
{*
<div class="fr">
	<button class="button" class="button blue"><i class="icon icon-plus-square"></i> Добавить виджет</button> &nbsp;
	<button class="button" class="button blue"><i class="icon icon-settings"></i> Настройки</button>
</div>
*}
    ...
    <div class="">
      <div class="streamline b-l b-accent m-b">
        <div class="sl-item sl-item-md">
          <div class="sl-icon">
            <i class="icon icon-check text-muted-dk"></i>
          </div>
          <div class="sl-content">
        ...
        <div class="sl-item sl-item-md b-success">
          <div class="sl-icon">
            <i class="icon icon-twitter text-success"></i>
          </div>
          <div class="sl-content">
        ...
        <div class="sl-item sl-item-md b-info">
          <div class="sl-icon">
            <i class="icon icon-bolt text-info"></i>
          </div>
          <div class="sl-content">
...
<div class="dashboard-item__widgets">
	<div class="widget">
		<div class="dashboard-item__drag"><div class="dashboard-item__drag__item"><i class="icon icon-apps"></i></div></div>
		<div class="dashboard-item__edit"><i class="icon icon-settings"></i></div>
