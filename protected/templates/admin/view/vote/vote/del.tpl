...
<form method="post" action="">
	...
	<div class="button-container">
		<a href="/{$ADMIN_DIR}/vote/" class="button button-blue"><i class="icon icon-arrow-left"></i>Нет</a>
		<button class="button button-red" type="button" onclick="return cp.dialog( 'Требуется подтверждение удаления!' );"><i class="icon icon-delete"></i>Подтверждаю удаление</button>
	</div>
</form>
{/strip}