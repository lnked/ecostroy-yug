...
<form method="post" action="" id="VoteAddForm">
	...
	<div class="button-container">
		<button class="button button-blue" name="save" type="submit" onclick="Check()"><i class="icon icon-save"></i>Сохранить</button>
		<a class="button button-red" href="/{$ADMIN_DIR}/vote/"><i class="icon icon-arrow-left"></i>Отмена</a>
	</div>
</form>
