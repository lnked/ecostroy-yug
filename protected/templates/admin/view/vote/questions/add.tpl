...
<form method="post" id="VoteAddQuestions">
	...
	<table class="table" id="ext_table">
        ...
        <tbody>
            ...
            <tr id="tr_{$item.id}">
                ...
                <td>
                    <a href="#" class="icon icon-edit" onclick="editExtendet('{$item.id}')">.</a>
                    <a href="#" class="icon icon-delete" onClick="delExtendet('{$item.id}')"></a>
                </td>		
            </tr>			
            {/foreach}
            <tr id="ajax_add_form">
                ...
                <td class="va_t">
                    <a href="#" class="button button-green" onclick="addExtendet();"><i class="icon icon-save"></i>Сохранить</a>
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <div class="button-container clearfix">
        <a href="#" class="button button-green" onclick="$('#ajax_add_form').show()"><i class="icon icon-plus-square"></i> Добавить</a>
    </div>
</form>
