                    ...
                    <table class="table" id="meta_data">
                        ...
                        <tbody>
                            ...
                            <tr id="docs_{$docs.id}">
                                ...
                                <td class="tacs">
                                    <a href="#" class="icon icon-save" title="Записать" onclick="return SaveDocs({$docs.id})"></a>
                                    <a href="#" class="icon icon-edit" title="Редактировать" onclick="return EditDocs({$docs.id})"></a>
                                    <a href="#" class="icon icon-delete remove-trigger" title="Удалить" onclick="return DelDocs({$docs.id})"></a>
                                </td>
                            </tr>
                            {/foreach}
                        </tbody>
            ...
            <tr>
                ...
                <td>
                    <div id="file_docs" class="file-list clearfix">
                        ...
                        <button class="button button-green" onclick="return ajaxFileDocsUpload('{$docs_item.group_name}')"><i class="icon icon-save"></i> Закачать</button>
                    </div>
                    
                    <a href="/{$ADMIN_DIR}/image_import/?act=read{if isset($docs_item.id )}&field_id={$docs_item.id}{/if}&group_id={$docs_item.group_name}"><i class="icon icon-paperclip"></i> Пакетный импорт файлов</a>
                </td>
            </tr>
            <tr>
