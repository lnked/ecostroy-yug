...
<form method="post" id="form_stc">
	...
	<div class="button-container-structure">
		<a href="#" class="button button-purple button-container-structure-add" onclick="return cp.addBlock({$stc_page.id}, event);"><i class="icon icon-plus-square"></i> Добавить часть страницы</a>
