                ...
                <tr id="settings-{$cnt.id}">
                    <td class="settings-row">
                        <div class="settings-container clearfix">
                            ...
                            <a href="#" onclick="return cp.removeSettings({$cnt.id}, event);" class="block-settings-link block-settings-remove"><i class="icon icon-delete"></i>Удалить часть страницы</a>
                            ...
                            <div class="settings-container-toggle" id="settings-container-toggle-{$cnt.id}">
                                ...
                                <div class="block-settings-buttons clearfix">
                                    <a href="#" onclick="return cp.saveSettings({$cnt.id}, event);" class="button button-purple block-settings-save"><i class="icon icon-check-square"></i>Сохранить</a>
                                </div>
                            </div>
                        </div>
                    </td>
