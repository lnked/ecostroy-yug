...
<script src="/{$ADMIN_DIR}/js/vendors.min.js" data-no-instant></script>
<script src="/{$ADMIN_DIR}/js/libs.min.js" data-no-instant></script>
...
<script src="/{$ADMIN_DIR}/js/scripts.min.js" data-no-instant></script>
<script src="/{$ADMIN_DIR}/js/shopping.min.js" data-no-instant></script>
<script src="/{$ADMIN_DIR}/js/module.min.js" data-no-instant></script>
