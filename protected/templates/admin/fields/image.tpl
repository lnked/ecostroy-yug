...
<script type="text/template" id="upload-template">
    ...
    <div class="qq-uploader-selector qq-uploader" qq-drop-area-text="Drop files here">
		...
		<div class="attachments__selector">
			<i class="attachments__selector__icon icon icon-attachment-alt"></i> Перетащите {if isset($settings.f_file_count) && $settings.f_file_count == 1}изображение{else}изображения{/if} сюда или <a class="attachments__selector__link qq-upload-button-selector qq-upload-button" id="dropzone-{$name}-target" tabindex="-1">выберите ...</a>
		</div>
